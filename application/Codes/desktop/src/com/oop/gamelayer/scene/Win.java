...
public class Win extends BaseScene {
	...
	public Win(SimulationLifeCycleManagement game) {
		super(game);
	...
	protected void initUI() {
		...
		game.getInputOutputManagement().startSound("win");

		// set background = = =
		backgroundImage = new Image(new Texture(Gdx.files.internal("background/winscreenbg.png")));
	...
	public void loadMenu() {
		...
		// load title = = =
		Texture titleTexture = new Texture(Gdx.files.internal("background/win_title.png"));
